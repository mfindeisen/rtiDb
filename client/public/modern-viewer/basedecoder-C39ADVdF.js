//#region node_modules/.pnpm/geotiff@2.1.3/node_modules/geotiff/dist-module/predictor.js
function e(e, t) {
...
//#endregion
//#region node_modules/.pnpm/geotiff@2.1.3/node_modules/geotiff/dist-module/compression/basedecoder.js
var r = class {
	async decode(e, t) {
		let r = await this.decodeBlock(t), i = e.Predictor || 1;
		if (i !== 1) {
			let t = !e.StripOffsets;
			return n(r, i, t ? e.TileWidth : e.ImageWidth, t ? e.TileLength : e.RowsPerStrip || e.ImageLength, e.BitsPerSample, e.PlanarConfiguration);
		}
		return r;
	}
};
